      ...
      {isLoading ? (
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg lg:w-9/12 md:w-11/12 w-full sm:w-10/12  flex flex-col md:flex-row">
          <div className="flex-1 w-full lg:w-1/2 p-4">
            ...
            <p className="font-poppins font-normaltext-sm text-customRemember leading-4 ">
              ...
              <div className="flex flex-col items-start  font-medium font-poppins text-sm mb-8">
                <div className="flex flex-col items-center">
                  <div className="flex items-center">
                    ...
                    />
                    <label className="font-poppins font-md text-sm text-customRemember">
                      I agree to all the
                      <a href="#" className="text-customForgot font-poppins">
                        Terms
                      </a>
