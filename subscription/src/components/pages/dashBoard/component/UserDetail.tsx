...
const UserDetail = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div className="col-span-1 bg-white p-6 rounded-lg border border-customBlue relative">
        <div className="flex items-center space-x-4">
          <img src={  userDetail[0]?.profile_image||dianne.src} alt="User" className="w-24 h-24 rounded-full" />
          <div>
            <h2 className=" text-lg font-poppins font-medium">
              {userDetail.length > 0
                ? userDetail[0]?.name || "user name"
                : "user name"}
            </h2>
      ...
      <div className="col-span-1   bg-white p-6 rounded-lg space-y-1 border-customBlue border">
        ...
        <p className="text-customGray">
          {userDetail.length > 0
            ? userDetail[0]?.address ||
              "4340 Parker Rd, Allentown, New Mexico 31134"
            : "4340 Parker Rd, Allentown, New Mexico 31134"}
        </p>
        <p className="text-customNav font-poppins text-base lowercase">
          {userDetail.length > 0
            ? userDetail[0]?.email || "dianne.russell@gmail.com"
            : "dianne.russell@gmail.com"}
        </p>
        <p className="text-customNav font-poppins text-base">(671) 555-0100</p>
        <div className="mt-4">
          <a
            href="#"
