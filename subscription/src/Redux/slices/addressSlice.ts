...
import { addAddressBody } from "@/utils/Slice_Utils/User_utils";
...
export const editAddress= createAsyncThunk(" editAddress", async (Data:AddressData) => {
  try {
   const body =  addAddressBody(Data);
...
export const addressSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase( getUserAddress.fulfilled, (state: InititalState  , action: Action) => {
